...
public class DrivetrainOld extends Subsystem {
	...
	public DrivetrainOld() {
		...
		//Set names for these for Shuffleboard
		leftEncoder.setName("Drivetrain", "Left Encoder");
		rightEncoder.setName("Drivetrain", "Right Encoder");
        ((Spark) leftMotor).setName("DriveTrain", "Left Motor");
        ((Spark) rightMotor).setName("DriveTrain", "Right Motor");
        gyro.setName("Drivetrain", "Gyro");
        accel.setName("Drivetrain", "Accelerometer");
